...
1. Creating a Website instance:
    - To get started, specify the location of relevants link, as well as specify whitelists and other parameters:
      ...
      ```
      The public interface of the Website class is incredibly minimalistic. Its mainly consists of two methods: `dispatch_links` and `dispatch_links`
      
    - The method  `dispatch_links` crawls through the main pages of the news site, scraping news links according to the filters specified when creating the Website instance
      ```py
      # Example
